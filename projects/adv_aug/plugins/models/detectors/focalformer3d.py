...
from projects.adv_aug.plugins.core.post_processing.merge_augs import merge_aug_bboxes_3d
...
class FocalFormer3D(MVXTwoStageDetector):
    def __init__(self,
        ...
        if self.use_grid_mask:
            from projects.adv_aug.plugins.models.utils.grid_mask import GridMask
